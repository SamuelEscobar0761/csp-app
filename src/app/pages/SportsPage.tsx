...
export const SportsPage = () => {
    ...
    return(
        <div>
            ...
            <h2 className="py-5 text-[#80AE8A] text-5xl text-center">{t('sports_page.sports_title')}</h2>
            ...
            <div>
                <h2 className={`pt-10 text-[#80AE8A] text-center text-5xl`}>{t('sports_page.awards_title')}</h2>
